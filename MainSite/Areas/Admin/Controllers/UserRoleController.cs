    ...
    public class UserRoleController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(UserRoleModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //activity log
                //_customerActivityService.InsertActivity("AddNewUserRole",
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (UserRole.IsSystemRole && !model.Active)
                        throw new Exception("Admin.Customers.UserRoles.Fields.Active.CantEditSystem");

                    if (UserRole.IsSystemRole && !UserRole.SystemName.Equals(model.SystemName, StringComparison.InvariantCultureIgnoreCase))
                        throw new Exception("Admin.Customers.UserRoles.Fields.SystemName.CantEditSystem");
        ...
        public virtual IActionResult Delete(string id)
        {
            ...
            try
            {
                ...
                //activity log
                //   _customerActivityService.InsertActivity("DeleteUserRole",
