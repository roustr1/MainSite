...
namespace MainSite.ViewModels.Common
{
    ...
    public partial class PagerViewModel
    {
        ...
        {
            get => (!string.IsNullOrEmpty(firstButtonText)) ? firstButtonText : "Первая";
        ...
        {
            get => (!string.IsNullOrEmpty(lastButtonText)) ? lastButtonText : "Последняя";
        ...
        {
            get => (!string.IsNullOrEmpty(nextButtonText)) ? nextButtonText : "Далее";
        ...
        {
            get => (!string.IsNullOrEmpty(previousButtonText)) ? previousButtonText : "Предыдущая";
        ...
        {
            get => (!string.IsNullOrEmpty(currentPageText)) ? currentPageText : "Страница {0} из {1} ({2} всего)";
    ...
    /// <summary>
    /// Class that has a slug and page for route values.
    /// </summary>
