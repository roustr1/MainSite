    ...
    <div class="card-panel row">
        <ul class="pagination">
            ...
            <li v-if="ShowPrevious" class="previous-page btn btn-defaultMainSite">
                <a href="#" @click.prevent="changePage(Number(currentPage) - 1)" title="Предыдущая страница">Предыдущая</a>
            </li>
            <li 
                ...
                >
                <a href="#" @click.prevent="changePage(item.Index)" :title="setTitle(item.Index)">{{item.Index}}</a>
            </li>
            <li v-if="ShowNext" class="next-page btn btn-defaultMainSite">
                <a href="#" @click.prevent="changePage(Number(currentPage) + 1)" title="Следующая страница">Далее</a>
            </li>
