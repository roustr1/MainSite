...
namespace Application.Services.News
{
    ...
    public class NewsService : INewsService
    {
        ...
        {
            var collection = _newsRepository.GetMany(x => EF.Functions.FreeText(x.Description, query)|| EF.Functions.FreeText(x.Header, query)).OrderByDescending(c => c.CreatedDate).ThenByDescending(c => c.LastChangeDate);
